...
export const SEED_PROFILES: Record<string, Profile> = {
  ...
  sarah_dev: {
    ...
    avatar_url: "https://api.dicebear.com/9.x/notionists/svg?seed=sarah_dev&backgroundColor=c0aede",
  ...
  mike_builds: {
    ...
    avatar_url: "https://api.dicebear.com/9.x/notionists/svg?seed=mike_builds&backgroundColor=ffd5dc",
  ...
  jess_automates: {
    ...
    avatar_url: "https://api.dicebear.com/9.x/notionists/svg?seed=jess_automates&backgroundColor=d1f4d9",
